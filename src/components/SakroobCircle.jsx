...
const SakroobCircle = () => {
    return (
        <div className="p-6 relative min-h-[386px]">
            <div className="relative -bottom-[141px]  rounded-[24px]  pointer-events-none bg-cover bg-no-repeat bg-center min-h-[386px] max-w-[1140px] left-1/2 -translate-x-1/2  flex justify-center items-center flex-col w-full"
                style={{
